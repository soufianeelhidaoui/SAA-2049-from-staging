...
class TwigGlobalSubscriber implements EventSubscriberInterface
{
    ...
    private $legalContentRepository;
    private $router;

    public function __construct(Environment $twig, LocaleContextInterface $localeContext, ContainerInterface $container, TaxonRepository $taxonRepository, RepositoryInterface $menuRepository, RegistryInterface $settingsRegistry, UrlGeneratorInterface $router, LegalContentRepository $legalContentRepository)
    {
        $this->twig = $twig;
    ...
    public function injectGlobalVariables(ControllerEvent $event)
    {
        ...
        $legalContent = $this->legalContentRepository->findAll();
        $this->twig->addGlobal('legalContent', $legalContent);
    }
